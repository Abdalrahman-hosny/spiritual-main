...
export default function Navbar({ bg }) {
  ...
  const LanguageDropdown = ({ isMobile = false }) => (
    <div className="relative">
      <button
        ...
        className={`${
          isMobile ? "w-7 h-7" : "w-9 xl:w-10 h-9 xl:h-10"
        } bg-white bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-all duration-200`}
        aria-label="Select Language"
      >
        <FaGlobe
          className={`${
            isMobile ? "text-[12px]" : "text-[15px] xl:text-[18px]"
          } text-purple-500`}
        />
      </button>
      {isLanguageDropdownOpen && (
        <div
          ...
          } mt-2 w-32 bg-white shadow-xl rounded-lg border border-gray-100 transition-all duration-200 z-50`}
        >
          <div className="py-1">
            <button
      ...
      <div className="relative">
        ...
        {isAuthDropdownOpen && (
          <div
            className={`absolute ${
              isRTL ? "left-0" : "right-0"
            } mt-2 w-48 bg-white shadow-xl rounded-lg border border-gray-100 transition-all duration-200 z-50`}
          >
            <div className="py-1">
              {isLoggedIn ? (
                <>
                  ...
                  <button
                    ...
                    className={`w-full px-4 py-2 text-sm text-gray-700 hover:bg-purple-50 hover:text-purple-600 transition-colors duration-150 ${
                      isRTL ? "text-right" : "text-left"
                    }`}
                  >
  ...
  return (
    <div
      className={`fixed mb-3 top-0 left-0 w-full z-[9999] bg-transparent backdrop-blur-sm ${
        bg ? bg : "bg-black/70"
      }`}
    >
      <nav className="w-[95%] lg:w-[90%] xl:w-[85%] 2xl:w-[80%] mx-auto flex items-center justify-between px-2 sm:px-4 py-3 sm:py-4 h-full">
                ...
                >
                  ...
                  {link.hasDropdown && (
                    <div
                      ...
                      } mt-1 w-44 bg-white shadow-xl rounded-lg border border-gray-100 transition-all duration-200 z-50
                      ${
        ...
        >
          ...
          <Link
            to="/wishlist"
            className="w-8 cursor-pointer h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-all duration-200"
          >
        ...
        >
          ...
          <Link
            to="/wishlist"
            className="w-7 h-7 cursor-pointer bg-white bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-all duration-200"
          >
        ...
        >
          <div
            className={`absolute top-0 ${
              isRTL ? "right-0" : "left-0"
            } w-full sm:w-80 bg-white shadow-2xl max-h-screen overflow-y-auto`}
          ...
          >
                ...
                link.hasDropdown ? (
                  <div key={link.path}>
                    <button
                      ...
                      className={`w-full ${
                        isRTL ? "text-right" : "text-left"
                      } px-6 py-4 font-montserrat-arabic font-medium text-[16px] sm:text-[18px] transition-all duration-200 flex items-center justify-between
                        ${
                          isCategoriesOpen
                  ...
                  <Link
                    ...
                    to={link.path}
                    onClick={toggleMobileMenu}
                    className={`block px-6 py-4 font-montserrat-arabic font-medium text-[16px] sm:text-[18px] transition-all duration-200 border-b border-gray-100 ${
                      isRTL ? "text-right" : "text-left"
                    }
                      ${
                        location.pathname === link.path
            ...
            <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
              <p
                className={`text-sm text-gray-500 text-center font-montserrat-arabic`}
              >
                {t("footerText")}
              </p>
            </div>
